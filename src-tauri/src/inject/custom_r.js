...
(function () {
  ...
  function engineTargetAlive() {
    ...
    return frameHasLiveCanvas(engineTarget.win) ||
           (!engineTarget.host && looksLikeComfyWindow()); // self before mount
  }
  ...
  function resolveEngineTarget() {
    ...
    if ((frameHasLiveCanvas(window) || looksLikeComfyWindow()) && document.body) {
  ...
  function createFloatingMenu() {
    ...
    if (liveSrcEl) {
      liveSrcEl.textContent = "live script copy: " +
        (window.__RH_LIVE_SOURCE__ === "cache" ? "LAST-GOOD CACHE" : "OVERRIDE");
    }
  ...
  function openScriptEditor() {
    ...
    const label =
      (window.__RH_LIVE_SOURCE__ === "cache" || (window.__RH_LIVE_SOURCE__ !== "override" && overrideSrc == null && cacheSrc != null))
        ...
        : overrideSrc != null || window.__RH_LIVE_SOURCE__ === "override"
          ...
          : "— none —";
    const prefill = overrideSrc != null ? overrideSrc : (cacheSrc != null ? cacheSrc : "");
